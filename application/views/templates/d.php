...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('css/dashboard.css'); ?>" media="screen">
    ...
    <svg style="display:none;">
      ...
      <header class="page-header">
        <nav>
          ...
          <a href="update_user/<?php echo $this->session->userdata('id');?>"><img src="<?php echo base_url("upload/".$this->session->userdata('photo'));?>" class="imagebox" alt=""  style="width:100px;height:100px;border-radius:50px;">
          ...
          <ul class="admin-menu">
            ...
            <li>
              <a href="update_user/<?php echo $this->session->userdata('id');?>">
                <svg>
      ...
      <section class="page-content">
        <section class="search-and-user">
          ...
          <div class="admin-profile">
            <span class="greeting"><?php echo $this->session->userdata('name'); ?></span>
